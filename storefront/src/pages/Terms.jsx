      ...
      <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', gap: '4rem', maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div className="terms-content" style={{ color: '#475569', lineHeight: 1.7 }}>
          ...
          <section id="section-1" style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>By accessing and using the Art & Craft website (the "Site"), you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.</p>
          ...
          <section id="section-2" style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>Permission is granted to temporarily view the materials on Art & Craft's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:</p>
          ...
          <section id="section-3" style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>All content included on the Site, such as text, graphics, logos, images, audio clips, digital downloads, and data compilations, is the property of Art & Craft or its content suppliers and protected by international copyright laws.</p>
          ...
          <section id="section-4" style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>Art & Craft reserves the right to refuse any order you place with us. We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order.</p>
          ...
          <section id="section-6" style={{ marginBottom: '3rem' }}>
            ...
            <p>In no event shall Art & Craft or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our website.</p>
          </section>
          ...
          <section id="section-7" style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>Questions about the Terms of Service should be sent to us at legal@artandcraft.com or via mail at:</p>
            <p>Art & Craft Legal Dept.<br/>1221 Artisan Way, Suite 400<br/>Portland, OR 97201, USA</p>
          </section>
